...
async function main() {
  // ----- Users -----
  // not needed get from old commits if you wish to see
      ...
      questions: {
        create: [
          ...
          },
          {
            category: "Comprehension",
            question:
              "What concern does the passage raise about AI's evolution?",
            options: {
              create: [
          ...
          },
          {
            category: "Comprehension",
            question:
              "What promise do self-driving vehicles offer according to the passage?",
            options: {
              create: [
        ...
        create: [
          {
            category: "Comprehension",
            question:
              "What does the passage identify as the primary drivers of global warming?",
            options: {
              create: [
          ...
          },
          {
            category: "Comprehension",
            question:
              "Which consequence of rising temperatures is NOT mentioned in the passage?",
            options: {
              create: [
          ...
          },
          {
            category: "Comprehension",
            question:
              "What renewable energy technologies are mentioned as becoming more efficient?",
            options: {
              create: [
          ...
          },
          {
            category: "Comprehension",
            question:
              "What international agreement is mentioned in the passage?",
            options: {
              create: [
                { text: "Kyoto Protocol" },
  ...
  const questionData = [
    ...
    {
      category: "Aptitude",
      question: "What is the next number: 1, 1, 2, 3, 5, ?",
      correctOptionId: 3,
    },
    ...
    },
    {
      category: "Verbal",
      question:
        "Which word is spelled correctly: accomodate, accommodate, acommodate?",
      correctOptionId: 2,
    },
    {
      category: "Verbal",
    ...
    {
      category: "Verbal",
      question: "Choose the correct word: The team ___ playing well.",
      correctOptionId: 1,
    },
  ...
  questions.forEach((q, index) => {
    if (q.category === "Aptitude") {
      ...
      const coreOptions = [
        ...
        ["Queue", "Stack", "Array", "Tree"],
        [
          "Speed vs compilation",
          "Memory usage",
          "Execution vs translation",
